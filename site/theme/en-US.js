...
module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.pro': 'CDesign Pro',
    ...
    'app.home.components-explain':
      'Based on the CDesign language, we have provided a suite of out-of-the-box with high quality for developing and serving enterprise background applications, including the official React implementation and Angular, Vue implementations',
    'app.home.product-pro-slogan': 'Out-of-the-box front-end / Design solution',
    'app.home.product-mobile-slogan':
      "antd-mobile is the implementation of CDesign's mobile specification",
    'app.home.product-landing-slogan':
      'Landing Pages templates and specifications based of CDesign language',
    'app.home.product-antv-slogan':
      'Simple, professional, with unlimited possibilities for data visualization solutions',
    'app.home.tool-package-title': 'CDesign Resources',
    'app.home.tool-package-content': 'CDesign Resources Download',
    ...
    'app.home.more-mobile-react': 'CDesign Mobile of React',
    'app.home.more-mobile-angular': 'CDesign Mobile of Angular',
    'app.footer.repo': 'GitHub Repository',
    'app.footer.awesome': 'Awesome CDesign',
    'app.footer.course': 'CDesign Practical Tutorial',
