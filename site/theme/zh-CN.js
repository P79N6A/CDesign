...
module.exports = {
  ...
  messages: {
    ...
    'app.home.components-explain':
      '基于 CDesign 设计语言，我们提供了开箱即用的高质量 React 和 Angular 组件实现，用于开发和服务于企业级中后台产品。',
    'app.home.product-pro-slogan': '开箱即用的中台前端/设计解决方案',
    'app.home.product-mobile-slogan': 'antd-mobile 是 CDesign 移动规范的实现',
    'app.home.product-antv-slogan': '简单、专业、拥有无限可能的数据可视化解决方案',
    'app.home.product-landing-slogan': '基于 CDesign 设计语言的 Landing 模板与规范',
    'app.home.tool-package-title': 'CDesign 资源包',
    'app.home.tool-package-content': 'CDesign 相关设计资源下载',
    ...
    'app.footer.course': 'CDesign 实战教程',
