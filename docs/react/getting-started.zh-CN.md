...
CDesign React 致力于提供给程序员**愉悦**的开发体验。
...
> 注意，不同于 CDesign，CDesign Pro 是只支持到 IE11+ 的。
...
CDesign 3.0 对 React 15/16 两个版本提供支持，但是我们强烈建议你升级到 React 16，以便获得更好的性能和遇到更少的问题。
