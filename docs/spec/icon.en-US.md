...
An icon is a graphical representation of meaning. Icons can be used to express actions, state, and even to categorize data. CDesign's icons adhere to the following two principles and are designed for cross-platform consistency:
...
System icons are often used to represent commonly used operations, such as: save, edit, delete. CDesign also includes icons to represent file types and state.

- [View the icon](/components/icon/)

### Key Contour Lines

<img class="preview-img no-padding" align="right" src="https://gw.alipayobjects.com/zos/rmsportal/beTZeZjJBVuhMyTOhebs.png" alt="CDesign's grid and key contour lines" alt="Key Contour Lines">
...
Consistent stroke weight is the key to maintaining the visual unity of the entire icon system. CDesign's icons have a consistent line width of 72px.
...
Icons that follow CDesign should have rounded corners and edges using a 72px radius.
...
Icons should be scaled according to the text size, according to the CDesign specification.
